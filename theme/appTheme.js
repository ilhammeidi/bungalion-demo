...
const appTheme = (color, mode) => ({
  palette: {
    ...
    primaryLight: {
      main: palette[color].palette.primary.light,
      contrastText: palette[color].palette.primary.dark,
    },
    secondaryLight: {
      main: palette[color].palette.secondary.light,
      contrastText: palette[color].palette.secondary.dark,
    },
    action: {
